...
logger.log_info("开始 Stage3: 联合微调")
...
# 加载Stage2的模型权重
try:
    model.load_state_dict(torch.load('checkpoints/stage2_epoch30.pth'))
    logger.log_info("成功加载Stage2模型权重")
except:
    logger.log_info("未找到Stage2模型权重，使用随机初始化")
